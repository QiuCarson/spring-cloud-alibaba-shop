...
public class CategoryController {
     ...
     */
    @GetMapping("list")
    public ResponseEntity<List<CategoryDTO>> queryCategoryByPid(@RequestParam(value = "pid", defaultValue = "0") Long pid) {
        List<CategoryDTO> categoryList = categoryService.queryCategoryByPid(pid);
     ...
     */
    @GetMapping("bid/{bid}")
    public ResponseEntity<List<CategoryDTO>> queryCategoryByBid(@PathVariable("bid") Long bid) {
